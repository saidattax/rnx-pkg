...
var Collection = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: utils_1.cs('notion-collection', className) },
        ...
        react_1["default"].createElement(collection_view_1.CollectionView, { collection: collection, collectionView: collectionView, collectionData: collectionData, padding: 0, width: width })));
};
